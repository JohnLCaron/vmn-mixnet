...
private const val BYTETREE_GROUP_NAME : String = "com.verificatum.arithm.ModPGroup"
...
fun ModPGroupBt.publish() : ByteTreeNode {
    return makeNode(name,
            listOf(
                makeLeaf("name", BYTETREE_GROUP_NAME.toByteArray()),
...
fun IntGroupContext.makeModPGroupBt(encoding: Int) : ModPGroupBt {
    val egkConstants = this.groupConstants
