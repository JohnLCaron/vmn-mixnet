...
import org.cryptobiotic.verificabitur.testByteArrayEquals
...
class ModPGroupBtTest {
    ...
    fun testReadModPGroup() {
        ...
        testByteArrayEquals(egkConstants.generator.toByteArray(), modPGroup.generator.toByteArray())
        testByteArrayEquals(egkConstants.smallPrime.toByteArray(), modPGroup.order.toByteArray())
        testByteArrayEquals(egkConstants.largePrime.toByteArray(), modPGroup.modulus.toByteArray())
    }
